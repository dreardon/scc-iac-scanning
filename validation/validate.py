...
print('Found detectors:',len(found_detectors),found_detectors)
...
print('Supported detectors:',len(supported_detectors),supported_detectors)


missing_detectors = list(set(supported_detectors) - set(found_detectors))
print('Missing detectors:',len(missing_detectors),missing_detectors)